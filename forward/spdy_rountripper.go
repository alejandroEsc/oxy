...
func (s *SpdyRoundTripper) RespondConn() net.Conn {
	return s.conn
}
...
func (s *SpdyRoundTripper) NewConnection(resp *http.Response) (httpstream.Connection, error) {
	...
	if (resp.StatusCode != http.StatusSwitchingProtocols) || !strings.Contains(connectionHeader, strings.ToLower(httpstream.HeaderUpgrade)) || !strings.Contains(upgradeHeader, strings.ToLower(k8spdy.HeaderSpdy31)) {
	...
	return k8spdy.NewClientConnection(s.conn)
}
